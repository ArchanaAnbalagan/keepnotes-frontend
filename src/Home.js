...
function Home() {
    ...
    const fetchNotes = async () => {
        try {
            const response = await axios.get(`https://keepnotes-backend-69st.vercel.app/notesget/${user_id}`);
    ...
    const handleSubmit = async (title, content) => {
        if (title !== "" && content !== "") {
            try {
                const response = await axios.post('https://keepnotes-backend-69st.vercel.app/notespost', {
                    note_title: title,
    ...
    const handleUpdate = async (id, title, content) => {
        if (title !== "" && content !== "") {
            try {
                const response = await axios.put(`https://keepnotes-backend-69st.vercel.app/notes/${id}`, {
                    note_title: title,
                    note_content: content,
                    user_id:user_id
                });
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://keepnotes-backend-69st.vercel.app/notes/${id}`, {
